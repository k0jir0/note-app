...
const controller = createModuleController({
    ...
    overviewErrorMessage: 'Unable to load the Playwright Testing module overview.',
    scriptErrorMessage: 'Unable to load the Playwright spec template.',
    readyMessage: 'Playwright Testing module ready. Select a scenario to preview a starter spec.',
    refreshSuccessMessage: 'Playwright Testing module refreshed.',
