...
const controller = createModuleController({
    ...
    overviewErrorMessage: 'Unable to load the Selenium Testing module overview.',
    scriptErrorMessage: 'Unable to load the Selenium script template.',
    readyMessage: 'Selenium Testing module ready. Select a scenario to review the latest run and preview a starter WebDriver script.',
    refreshSuccessMessage: 'Selenium Testing module refreshed.',
