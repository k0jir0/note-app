...
const COMMON_ROUTE_DESCRIPTIONS = {
    ...
    '/research': 'Opens the Research Workspace, the hub for the Security Operations, Alert Triage ML, Selenium Testing, Playwright Testing, and Self-Healing Locator Repair modules.',
    '/security/module': 'Opens the Security Operations Module so the suite can verify analysis, scan import, correlation, and automation controls.',
    '/ml/module': 'Opens the Alert Triage ML Module so the suite can verify training, autonomy, and explainability panels.',
    '/selenium/module': 'Opens the Selenium Testing Module so the suite can verify the Selenium export surface and latest-run metadata.',
    '/playwright/module': 'Opens the Playwright Testing Module so the suite can verify the Playwright export surface.',
    '/self-healing/module': 'Opens the Self-Healing Locator Repair Module so the suite can verify ML-assisted repair suggestions and runtime self-heal guidance.'
};
...
const COMMON_ASSERTION_DESCRIPTIONS = {
    ...
    'Security Module card is present': 'Checks that the Research page still links to the Security Operations Module.',
    'ML Module card is present': 'Checks that the Research page still links to the Alert Triage ML Module.',
    'Selenium Module card is present': 'Checks that the Research page still links to the Selenium Testing Module.',
    'Playwright Module card is present': 'Checks that the Research page still links to the Playwright Testing Module.',
    'Self-Healing Module card is present': 'Checks that the Research page still links to the Self-Healing Locator Repair Module.',
    ...
    'Security Module heading is visible': 'Confirms that navigation reached the Security Operations Module.',
    ...
    'Sample log helper loads log input': 'Checks that the sample log helper populates the Security Operations Module input.',
    ...
    'ML Module heading is visible': 'Confirms that navigation reached the Alert Triage ML Module.',
...
const COMMON_TAG_DESCRIPTIONS = {
    ...
    security: 'Covers the Security Operations Module and related workflow surfaces.',
