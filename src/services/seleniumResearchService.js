...
const ROUTE_DESCRIPTIONS = {
    ...COMMON_ROUTE_DESCRIPTIONS,
    '/security/module': 'Opens the Security Operations Module so the suite can verify log analysis, scan import, and correlation controls.',
    '/ml/module': 'Opens the Alert Triage ML Module so the suite can verify training, autonomy, and recent scored-alert panels.',
    '/selenium/module': 'Opens the Selenium Testing Module so the suite can verify exported WebDriver coverage and latest-run metadata.',
    '/playwright/module': 'Opens the Playwright Testing Module so cross-module Selenium navigation can confirm the broader browser-testing workflow.',
    '/injection-prevention/module': 'Opens the Query Injection Prevention Module so the suite can verify architectural injection hardening and safe query templates.',
    ...
    '/self-healing/module': 'Opens the Self-Healing Locator Repair Module so the suite can verify that repair suggestions still render in the research workflow.',
    '/session-management/module': 'Opens the Session Security Module so the suite can verify strict timeout posture, live session state, and lockdown-evaluation controls.',
    ...
    '/mission-assurance/module': 'Opens the Mission Access Assurance Module so the suite can verify tactical access-policy evaluation and current-user security context.'
};
...
const ASSERTION_DESCRIPTIONS = {
    ...
    'Refresh Module button reloads the ML overview': 'Checks that the Alert Triage ML Module refresh control updates the module overview in place.',
    ...
    'Scenario count is visible': 'Checks that the Selenium Testing Module surfaces how many registered scenarios it knows about.',
    ...
    'Security Module script preview references the security route': 'Checks that the Security workflow template still points at the Security Operations Module path.',
    'Research full suite preview references cross-module routes': 'Checks that the full-suite template still covers the Security Operations, Alert Triage ML, Selenium Testing, and Playwright Testing pages.',
    'Refresh Module button reloads the overview': 'Checks that the Selenium Testing module refresh action reloads the latest overview data.',
    ...
    'Injection Prevention Module renders hardening controls': 'Confirms that the Query Injection Prevention page still renders hardening posture and safe query templates.',
    ...
    'Self-Healing Module renders repair suggestions': 'Confirms that the Self-Healing Locator Repair page still renders ranked repair suggestions.',
    ...
    'Security Module renders its workflow controls': 'Checks that the Security Operations Module still renders the controls used by the Selenium workflow.',
    'ML Module renders its autonomy controls': 'Checks that the Alert Triage ML Module still renders its training and autonomy surfaces.',
    'Selenium Module renders latest suite metadata': 'Checks that the Selenium Testing Module still renders latest-run and export metadata.',
    'Playwright Module renders its starter spec preview': 'Checks that the Playwright Testing Module still renders its generated starter spec preview.',
    ...
    'Mission Assurance Module renders policy evaluator': 'Confirms that the Mission Access Assurance page renders its policy evaluator and current profile summary.'
};
...
const SCRIPT_STEP_MAP = {
    ...
    'workspace-navigation': [
        ...
        'await expectBodyText(driver, \'Research Workspace\');',
        'await expectBodyText(driver, \'Security Operations Module\');',
        'await expectBodyText(driver, \'Alert Triage ML Module\');',
        'await expectBodyText(driver, \'Selenium Testing Module\');',
        'await expectBodyText(driver, \'Playwright Testing Module\');',
        'await expectBodyText(driver, \'Query Injection Prevention Module\');',
        'await expectBodyText(driver, \'XSS and CSP Defense Module\');',
        'await expectBodyText(driver, \'Server Access Control Module\');',
        'await expectBodyText(driver, \'Self-Healing Locator Repair Module\');',
        'await expectBodyText(driver, \'Session Security Module\');',
        'await expectBodyText(driver, \'Hardware-Backed MFA Module\');',
        'await expectBodyText(driver, \'Mission Access Assurance Module\');'
    ].join('\n        '),
    ...
    'ml-module-workflow': [
        ...
        'await waitForBodyText(driver, \'Alert Triage ML Module refreshed.\');',
    ...
    'xss-defense-module-smoke': [
        ...
        'await expectBodyText(driver, \'XSS and CSP Defense Module\');',
        'await expectBodyText(driver, \'Rendering And Header Controls\');',
        'await expectBodyText(driver, \'Directive Set\');',
    ...
    'mission-assurance-module-smoke': [
        ...
        'await expectBodyText(driver, \'RBAC\');',
        'await expectBodyText(driver, \'ABAC\');',
    ...
    'hardware-mfa-module-smoke': [
        ...
        'await expectBodyText(driver, \'Hardware token\');',
        'await expectBodyText(driver, \'PKI\');',
